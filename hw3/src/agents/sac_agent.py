...
class SoftActorCritic(nn.Module):
    ...
    def update_critic(
        ...
        with torch.no_grad():
            ...
            if self.use_entropy_bonus and self.backup_entropy:
                ...
                next_qs = next_qs + self.get_temperature() * next_action_entropy.unsqueeze(0)
                # ENDTODO
            ...
            target_values = reward.unsqueeze(0) + self.discount * (1 - done.float()).unsqueeze(0) * next_qs
            # ENDTODO
    ...
    def entropy(self, action_distribution: torch.distributions.Distribution):
        ...
        # Use rsample for reparameterized (differentiable) sampling
